...
\section{Relevancia e innovación del tema}
\label{sec:relevancia}

\textit{Justificar la relevancia e innovación del tema tratado.}

\section{Aportación del trabajo}
\label{sec:aportacion}

\textit{Describir la aportación original de este trabajo respecto a estudios previos.}
...
\textit{Los objetivos específicos están más relacionados con el resto de los capítulos del documento. Deben seguir los principios SMART.}
